...
public class BookingsControllerTest {
    ...
    public void setup() {
        ...
        when(mockedBookingRepository.findById(1l)).thenReturn(Optional.of(new Booking(mockedRooms, "I'd like spider webs in my room", LocalDateTime.of(1993, 1,1,1,1), LocalDateTime.of(1995,1,1,1,1)))); //De repo wordt niet echt gebruikt, maar je vertelt hoe het zich moet gedragen
    }
}
